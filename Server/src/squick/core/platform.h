...
#   define SQUICK_COMP_VER (((__GNUC__)*100) + \
                        (__GNUC_MINOR__*10) + \
                        __GNUC_PATCHLEVEL__)
...
#if SQUICK_PLATFORM == SQUICK_PLATFORM_LINUX || SQUICK_PLATFORM == SQUICK_PLATFORM_APPLE || SQUICK_PLATFORM == SQUICK_PLATFORM_APPLE_IOS || SQUICK_PLATFORM == SQUICK_PLATFORM_ANDROID || SQUICK_PLATFORM == SQUICK_PLATFORM_TEGRA2 || SQUICK_PLATFORM == SQUICK_PLATFORM_NACL
...
bool SQUICK_StrTo(const std::string& value, DTYPE& nValue)
{
    try
    {
