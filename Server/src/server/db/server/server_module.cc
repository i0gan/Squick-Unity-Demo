...
bool DBNet_ServerModule::AfterStart()
{
	...
	m_pNetModule->AddReceiveCallBack(SquickStruct::REQ_ROLE_LIST, this, &DBNet_ServerModule::OnRequireRoleListProcess);
	m_pNetModule->AddReceiveCallBack(SquickStruct::REQ_CREATE_ROLE, this, &DBNet_ServerModule::OnCreateRoleGameProcess);
	m_pNetModule->AddReceiveCallBack(SquickStruct::REQ_DELETE_ROLE, this, &DBNet_ServerModule::OnDeleteRoleGameProcess);
	m_pNetModule->AddReceiveCallBack(SquickStruct::REQ_LOAD_ROLE_DATA, this, &DBNet_ServerModule::OnLoadRoleDataProcess);
	m_pNetModule->AddReceiveCallBack(SquickStruct::REQ_SAVE_ROLE_DATA, this, &DBNet_ServerModule::OnSaveRoleDataProcess);
...
void DBNet_ServerModule::OnLoadRoleDataProcess(const SQUICK_SOCKET sockIndex, const int msgID, const char * msg, const uint32_t len)
{
	...
	SquickStruct::RoleDataPack xRoleDataxMsg;
