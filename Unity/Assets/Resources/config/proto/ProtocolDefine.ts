...
// -------------------------------------------------------------------------
	...
	class EffectData
	{
		...
		// IObject
		public static CampID = "CampID";// object
		public static ClassName = "ClassName";// string
		public static ConfigID = "ConfigID";// string
		public static Connection = "Connection";// int
		public static Disable = "Disable";// int
		public static GMMoveTo = "GMMoveTo";// vector3
	...
	class Item
	{
		...
		public static State = "State";// int
		// Property
		public static AwardData = "AwardData";// string
		public static AwardProperty = "AwardProperty";// string
		public static AwardPropertyValue = "AwardPropertyValue";// int
		public static BuyPrice = "BuyPrice";// int
		public static ConsumeData = "ConsumeData";// string
		...
		public static Extend = "Extend";// string
		public static Icon = "Icon";// string
		public static ItemSubType = "ItemSubType";// int
		public static ItemType = "ItemType";// int
		public static Job = "Job";// string
		public static Level = "Level";// int
		public static Quality = "Quality";// int
		public static SalePrice = "SalePrice";// int
		public static Script = "Script";// string
	...
	class NPC
	{
		...
		public static BUFF_GATE = "BUFF_GATE";// int
		public static CRITICAL = "CRITICAL";// int
		public static CommonCD = "CommonCD";// float
		public static DEF_DARK = "DEF_DARK";// int
		public static DEF_FIRE = "DEF_FIRE";// int
		public static DEF_ICE = "DEF_ICE";// int
		public static DEF_LIGHT = "DEF_LIGHT";// int
		...
		public static REFLECTDAMAGE = "REFLECTDAMAGE";// int
		public static Refresh = "Refresh";// int
		public static SKILL_GATE = "SKILL_GATE";// int
		...
		// Include Record, come from CooldownRecord 
	...
	class Player
	{
		...
		public static BUFF_GATE = "BUFF_GATE";// int
		public static BattlePoint = "BattlePoint";// int
		public static CRITICAL = "CRITICAL";// int
		public static ClanID = "ClanID";// object
		...
		public static ReconnectReason = "ReconnectReason";// int
		public static SKILL_GATE = "SKILL_GATE";// int
		public static SP = "SP";// int
		public static SUCKBLOOD = "SUCKBLOOD";// int
		public static ScenarioProgress = "ScenarioProgress";// int
		public static Sex = "Sex";// int
		public static SkillNormal = "SkillNormal";// string
		public static SkillSpecial1 = "SkillSpecial1";// string
		public static SkillSpecial2 = "SkillSpecial2";// string
		public static SkillTHUMP = "SkillTHUMP";// string
		public static TeamID = "TeamID";// object
		...
		public static HeroEquipmentList = 
		{
			//Class name
			"ThisName":"HeroEquipmentList",
			"HeroID":0,
			"EquipmentID":1,
			"SlotIndex":2
		}
		public static HeroList = 
		{
			//Class name
			"ThisName":"HeroList",
			"GUID":0,
		...
		public static InventoryEquipment = 
		{
			//Class name
	...
	class Scene
	{
		...
		public static RelivePosEx = "RelivePosEx";// string
		public static ResPath = "ResPath";// string
		public static ResourcePos = "ResourcePos";// string
		...
		public static SubType = "SubType";// int
	...
	class Server
	{
		...
		public static ServerID = "ServerID";// int
		public static Type = "Type";// int
		public static UDPPort = "UDPPort";// int
	...
	class Skill
	{
		...
		public static ConsumeValue = "ConsumeValue";// int
		public static CoolDownTime = "CoolDownTime";// float
		...
		public static ScriptObject = "ScriptObject";// string
		public static SendBuffList = "SendBuffList";// string
		public static ShowName = "ShowName";// string
		public static SkillSubType = "SkillSubType";// int
...
export const NFConfig={
		,EffectData,GM,Group,IObject,InitProperty,Item,Language,NPC,NoSqlServer,Player,Scene,Security,Server,Skill}
