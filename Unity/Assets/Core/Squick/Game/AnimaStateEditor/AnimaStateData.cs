...
namespace SquickProtocol
{
	...
	public class AnimaStateData : ScriptableObject
	{
		public List<string> VirtualPointList = new List<string> { "None" };
		public AnimaStateType DefaultAnimationType = AnimaStateType.Idle;
	...
	public class AnimationSkillStruct
	{
		...
		[Tooltip("GUI上显示的名称")]
		public AnimaStateType Type;
		public float fTime = 1.0f;
		public AnimaStateType NextType = AnimaStateType.Idle;
