...
public class NFStateData
{
    ...
    public AnimaStateType nextState = AnimaStateType.Idle;
}
...
public class IState
{
    ...
    protected AnimaStateMachine mStateMachine;
    ...
    public IState(GameObject gameObject, AnimaStateType eState, AnimaStateMachine xStateMachine, float fHeartBeatTime, float fExitTime, bool input)
    {
    ...
    public AnimaStateMachine GetStateMachine()
    {
