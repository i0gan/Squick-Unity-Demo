...
//will auto register in unity
        ...
        public static void Initialize(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            Uquick_Core_Log_Binding.Register(app);
            System_Type_Binding.Register(app);
            Uquick_Core_BindableProperty_1_Int64_Binding.Register(app);
            ...
            Uquick_AntiCheat_JFloat_Binding.Register(app);
            Uquick_AntiCheat_JLong_Binding.Register(app);
            WebSocketSharp_MessageEventArgs_Binding.Register(app);
            Uquick_Net_SocketIOEvent_Binding.Register(app);
            ...
            Uquick_AntiCheat_JInt_Binding.Register(app);
            UnityEngine_Debug_Binding.Register(app);
            Uquick_Core_ClassData_Binding.Register(app);
            Uquick_Core_ClassBind_Binding.Register(app);
            UnityEngine_TextAsset_Binding.Register(app);
            System_Boolean_Binding.Register(app);
            Uquick_Core_AssetMgr_Binding.Register(app);
            Updater_Binding.Register(app);
            ET_ETTask_1_UpdateBundleDataInfo_Binding.Register(app);
            Uquick_Net_SocketIOComponent_Binding.Register(app);
            Uquick_Net_JSocketConfig_Binding.Register(app);
            ...
            Uquick_Core_Loom_Binding.Register(app);
            ...
            Uquick_Core_CryptoHelper_Binding.Register(app);
            ...
            Uquick_Core_GameStats_Binding.Register(app);
