...
{
    unsafe class Uquick_Net_SocketIOComponent_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(Uquick.Net.SocketIOComponent);
            args = new Type[]{};
            ...
            args = new Type[]{typeof(System.String), typeof(System.Action<Uquick.Net.SocketIOEvent>)};
            ...
            args = new Type[]{typeof(System.String), typeof(Uquick.Net.JSocketConfig), typeof(System.Action<System.Object, WebSocketSharp.MessageEventArgs>)};
        ...
        static StackObject* get_IsConnected_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Uquick.Net.SocketIOComponent instance_of_this_method = (Uquick.Net.SocketIOComponent)typeof(Uquick.Net.SocketIOComponent).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
        ...
        static StackObject* On_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            System.Action<Uquick.Net.SocketIOEvent> @callback = (System.Action<Uquick.Net.SocketIOEvent>)typeof(System.Action<Uquick.Net.SocketIOEvent>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)8);
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* Init_15(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            Uquick.Net.JSocketConfig @config = (Uquick.Net.JSocketConfig)typeof(Uquick.Net.JSocketConfig).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
        ...
        {
            return ((Uquick.Net.SocketIOComponent)o).config;
        }

        static StackObject* CopyToStack_config_0(ref object o, ILIntepreter __intp, StackObject* __ret, IList<object> __mStack)
        {
            var result_of_this_method = ((Uquick.Net.SocketIOComponent)o).config;
            return ILIntepreter.PushObject(__ret, __mStack, result_of_this_method);
        }

        static void set_config_0(ref object o, object v)
        {
            ((Uquick.Net.SocketIOComponent)o).config = (Uquick.Net.JSocketConfig)v;
        }
        ...
        static StackObject* AssignFromStack_config_0(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, IList<object> __mStack)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            Uquick.Net.JSocketConfig @config = (Uquick.Net.JSocketConfig)typeof(Uquick.Net.JSocketConfig).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            ((Uquick.Net.SocketIOComponent)o).config = @config;
