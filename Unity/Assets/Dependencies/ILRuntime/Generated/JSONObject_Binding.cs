...
namespace ILRuntime.Runtime.Generated
{
    unsafe class JSONObject_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            field = type.GetField("keys", flag);
            app.RegisterCLRFieldGetter(field, get_keys_0);
            app.RegisterCLRFieldSetter(field, set_keys_0);
            app.RegisterCLRFieldBinding(field, CopyToStack_keys_0, AssignFromStack_keys_0);
        ...
        static object get_keys_0(ref object o)
        {
            return ((global::JSONObject)o).keys;
        }

        static StackObject* CopyToStack_keys_0(ref object o, ILIntepreter __intp, StackObject* __ret, IList<object> __mStack)
        {
            var result_of_this_method = ((global::JSONObject)o).keys;
            return ILIntepreter.PushObject(__ret, __mStack, result_of_this_method);
        }

        static void set_keys_0(ref object o, object v)
        {
            ((global::JSONObject)o).keys = (System.Collections.Generic.List<System.String>)v;
        }

        static StackObject* AssignFromStack_keys_0(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, IList<object> __mStack)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
