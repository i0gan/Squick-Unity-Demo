...
{
    unsafe class Uquick_Net_SocketIOEvent_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Uquick.Net.SocketIOEvent);
            args = new Type[]{};
        ...
        static StackObject* get_name_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Uquick.Net.SocketIOEvent instance_of_this_method = (Uquick.Net.SocketIOEvent)typeof(Uquick.Net.SocketIOEvent).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
