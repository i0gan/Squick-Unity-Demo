...
{
    unsafe class Uquick_Core_Tools_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Uquick.Core.Tools);
            ...
            app.RegisterCLRMethodRedirection(method, DestroyHotComponent_0);
            args = new Type[]{typeof(System.Object), typeof(System.Type)};
            method = type.GetMethod("CanAssignTo", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, CanAssignTo_1);


        }


        static StackObject* DestroyHotComponent_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Uquick.Core.Tools.DestroyHotComponent(@gameObject, @hotObject);

            return __ret;
        }

        static StackObject* CanAssignTo_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
            ...
            var result_of_this_method = Uquick.Core.Tools.CanAssignTo(@instance, @type);
