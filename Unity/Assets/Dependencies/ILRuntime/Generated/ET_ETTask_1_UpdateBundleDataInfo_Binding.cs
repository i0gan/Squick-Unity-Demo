...
{
    unsafe class ET_ETTask_1_UpdateBundleDataInfo_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ET.ETTask<BM.UpdateBundleDataInfo>);
            args = new Type[]{};
        ...
        static StackObject* GetAwaiter_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ET.ETTask<BM.UpdateBundleDataInfo> instance_of_this_method = (ET.ETTask<BM.UpdateBundleDataInfo>)typeof(ET.ETTask<BM.UpdateBundleDataInfo>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
