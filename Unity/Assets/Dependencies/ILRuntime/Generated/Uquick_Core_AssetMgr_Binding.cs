...
{
    unsafe class Uquick_Core_AssetMgr_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Uquick.Core.AssetMgr);
            ...
            args = new Type[]{typeof(System.String), typeof(System.Boolean), typeof(System.String), typeof(System.Action<System.Single>), typeof(System.Action<UnityEngine.AsyncOperation>)};
        ...
        static StackObject* Load_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = Uquick.Core.AssetMgr.Load(@path, @package);
        ...
        static StackObject* Unload_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Uquick.Core.AssetMgr.Unload(@path, @package);
        ...
        static StackObject* LoadSceneAsync_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            System.Action<UnityEngine.AsyncOperation> @finishedCallback = (System.Action<UnityEngine.AsyncOperation>)typeof(System.Action<UnityEngine.AsyncOperation>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)8);
            __intp.Free(ptr_of_this_method);
            ...
            Uquick.Core.AssetMgr.LoadSceneAsync(@path, @additive, @package, @loadingCallback, @finishedCallback);
