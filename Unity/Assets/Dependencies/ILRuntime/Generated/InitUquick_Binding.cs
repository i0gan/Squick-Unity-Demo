...
{
    unsafe class InitUquick_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(global::InitUquick);
        ...
        {
            global::InitUquick.Instance = (global::InitUquick)v;
        }
        ...
        static StackObject* AssignFromStack_Instance_0(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, IList<object> __mStack)
        {
            ...
            global::InitUquick @Instance = (global::InitUquick)typeof(global::InitUquick).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            global::InitUquick.Instance = @Instance;
            return ptr_of_this_method;
        }

        static object get_key_1(ref object o)
        {
            return ((global::InitUquick)o).key;
        }

        static StackObject* CopyToStack_key_1(ref object o, ILIntepreter __intp, StackObject* __ret, IList<object> __mStack)
        {
            var result_of_this_method = ((global::InitUquick)o).key;
            return ILIntepreter.PushObject(__ret, __mStack, result_of_this_method);
        }

        static void set_key_1(ref object o, object v)
        {
            ((global::InitUquick)o).key = (System.String)v;
        }
