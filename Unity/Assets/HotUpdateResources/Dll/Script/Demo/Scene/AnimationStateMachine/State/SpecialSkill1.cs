...
public class NFSpecialSkill1 : IState
{
    ...
    public NFSpecialSkill1(GameObject gameObject, AnimaStateType eState, AnimaStateMachine xStateMachine, float fHeartBeatTime, float fExitTime, bool input = false)
