...
public class SpecialSkill2 : IState
{
    ...
    public SpecialSkill2(GameObject gameObject, AnimaStateType eState, AnimaStateMachine xStateMachine, float fHeartBeatTime, float fExitTime, bool input = false)
