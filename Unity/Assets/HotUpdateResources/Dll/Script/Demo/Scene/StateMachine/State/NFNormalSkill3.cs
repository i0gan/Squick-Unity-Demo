...
public class NFNormalSkill3 : IState
{
    ...
    public NFNormalSkill3(GameObject gameObject, AnimaStateType eState, AnimaStateMachine xStateMachine, float fHeartBeatTime, float fExitTime, bool input = false)
