...
public class NFNormalSkill3 : NFIState
{
    ...
    public NFNormalSkill3(GameObject gameObject, AnimaStateType eState, NFAnimaStateMachine xStateMachine, float fHeartBeatTime, float fExitTime, bool input = false)
