...
public class NFNormalSkill4 : IState
{
    ...
    public NFNormalSkill4(GameObject gameObject, AnimaStateType eState, AnimaStateMachine xStateMachine, float fHeartBeatTime, float fExitTime, bool input = false)
