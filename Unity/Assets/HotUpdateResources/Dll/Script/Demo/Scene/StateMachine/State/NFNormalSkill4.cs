...
public class NFNormalSkill4 : NFIState
{
    ...
    public NFNormalSkill4(GameObject gameObject, AnimaStateType eState, NFAnimaStateMachine xStateMachine, float fHeartBeatTime, float fExitTime, bool input = false)
