...
{
	public class AnimatStateController : MonoBehaviour
	{
		[SerializeField] public AnimaStateData mxSkillData;
		...
		IEnumerator WaitPlayNextAnim(float time, AnimaStateType nextType, int index)
		{
        ...
        void PlayBulletToTarget(BulletStruct es, Transform firePoint, Transform target)
        {
            ...
            BodyIdent bodyIdent =  target.GetComponent<BodyIdent>();
