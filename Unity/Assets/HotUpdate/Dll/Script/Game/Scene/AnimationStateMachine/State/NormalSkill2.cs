...
public class NormalSkill2 : IState
{
    ...
    public NormalSkill2(GameObject gameObject, AnimaStateType eState, AnimaStateMachine xStateMachine, float fHeartBeatTime, float fExitTime, bool input = false)
