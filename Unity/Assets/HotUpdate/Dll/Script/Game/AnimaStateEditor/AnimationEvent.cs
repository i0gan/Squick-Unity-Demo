...
namespace SquickProtocol
{
	public class AnimationEvent
	{
		...
		public delegate void OnStartAnimaDelegation(GameObject self, AnimaStateType eAnimaType, int index);
		public delegate void OnEndAnimaDelegation(GameObject self, AnimaStateType eAnimaType, int index);
		public delegate void OnDamageDelegation(GameObject self, GameObject target, AnimaStateType eAnimaType, int index);
		public delegate void OnBulletTouchPositionDelegation(GameObject self, Vector3 position, AnimaStateType eAnimaType, int index);
		public delegate void OnBulletTouchTargetDelegation(GameObject self, GameObject target, AnimaStateType eAnimaType, int index);
		...
		public void OnStartAnimaEvent(GameObject self, AnimaStateType eAnimaType, int index)
		{
		...
		public void OnEndAnimaEvent(GameObject self, AnimaStateType eAnimaType, int index)
		{
        ...
        public void NoDamageEvent(GameObject self, GameObject target, AnimaStateType eAnimaType, int index)
        {
        ...
        public void OnDamageEvent(GameObject self, GameObject target, AnimaStateType eAnimaType, int index)
		{
		...
		public void OnBulletTouchPositionEvent(GameObject self, Vector3 position, AnimaStateType eAnimaType, int index)
		{
		...
		public void OnBulletTouchTargetEvent(GameObject self, GameObject target, AnimaStateType eAnimaType, int index)
		{
